package com.example.opct_notice.base.errormessage.quart;
...
import com.example.opct_notice.notice.service.impl.ErrorMessageOpceDoSendNoticeServiceImpl;
...
public class ErrorMessageSyncService extends AbstractGeneralNoticeService {
    private static final Logger LOGGER = LoggerFactory.getLogger(ErrorMessageSyncService.class);
    ...
    public void errorCodeSync() {
        LOGGER.info("定时任务启动：同步错误信息码");
        doSync();
    }
